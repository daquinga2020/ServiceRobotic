...
map_img = cv2.imread('RoboticsAcademy/exercises/static/exercises/vacuum_cleaner_loc/resources/images/mapgrannyannie.png', 0) 
...
# Weighta to model Gazebo to Pixel
# x_pixel to x_gz
X_gz2pxl_x1 = 412.07
X_gz2pxl_x2 = -70.854
# y_gz to y_pixel
...
# Weight to model Pixel to Gazebo
# x_pixel to x_gz
X_pxl2gz_x1 = 5.811
...
while True:
    ...
    if local_reached:
      ...
      local_reached = False
      if index >= len(pth_absolute): # When the robot finish their path, robot will wait
          print("FINISH")
          time.sleep(60)
      ...
      count = 0
      last_distance = distance_goal
      print("NEW GLOBAL GOAL: ", pth_absolute[index], "ACTUAL POSITION: ", (rob_x, rob_y), "TURN:", dir)
    ...
    print("DISTANCE:", round(distance_goal, 4))
    print("W:", w, "TURN:", dir, "POS", (round(rob_x, 4), round(rob_y, 4)))
    print("")
