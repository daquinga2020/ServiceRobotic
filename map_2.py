...
# Con el mapa reescalado obtener un nuevo modelo lineal
...
'''i = 714
print("CELDA: ", free_cells[i])
fill_cell(map_erosion, free_cells[i][0], free_cells[i][1], cell_x, cell_y, 150)
cv2.imshow('MAP', map_erosion)'''
...
# x_map = [720, 828, 828, 612, 504, 432, 306, 108, 54, 54, 198, 198, 54, 54, 54]
# y_map = [846, 486, 288, 288, 288, 288, 108, 108, 72, 468, 468, 702, 702, 810, 846]
# a = []
